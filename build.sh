...
echo Exporting Your User Name
export KBUILD_BUILD_USER=omkar

echo  Exporting Your Host Name
export KBUILD_BUILD_HOST=megatron007

###### defines ######

local_dir=$PWD
defconfig=moto_x_tycoo_defconfig
jobs=4
...
echo 'making clean'
echo '#############'
make clean && mrproper                                                                # clean 
the sources
rm -rf out                                                                 # clean the output 
folder
echo '#############'
...
cd $local_dir                                                              # cd back to the old 
dir
echo ''
echo '#############'
